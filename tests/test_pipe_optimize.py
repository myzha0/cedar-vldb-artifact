...
from ember.pipes import NoopPipe, Pipe, PipeVariantType, MapperPipe
from ember.sources import IterSource
from ember.pipes.optimize import FusedOptimizerPipe
...
def test_basic_optimizer_pipe():
    from ember.pipes.optimize import NoopOptimizerPipe
...
def test_prefetcher():
    from ember.pipes.optimize import PrefetcherPipe

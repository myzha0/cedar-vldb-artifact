...
from ember.pipes import NoopPipe, Pipe, MapperPipe
...
def get_checkpoint_dir():
    """
    Returns the ember checkpoint dir as pathlib.Path.
    """
...
def get_checkpoint_file():
    """
    Returns the ember checkpoint file as pathlib.Path.
    """
    checkpoint_dir = get_checkpoint_dir()
    checkpoint_file = checkpoint_dir / pathlib.Path("ember_checkpoint.pkl")

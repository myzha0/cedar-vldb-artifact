...
from ember.sources import LocalLineSource

from evaluation.ember_utils import EmberEvalSpec
from ember.pipes.custom.wikitext103 import _tokenize, _truncate, _embedding
...
if __name__ == "__main__":
    ds = get_dataset(EmberEvalSpec(1, None, 1))

"""
Main module that provides a CLI interface to run eval for ember datasets.
"""
...
def _get_profiler(dataset_file: str, dataset_func: str, spec: EmberEvalSpec):
...
def create_spec(args: argparse.Namespace) -> EmberEvalSpec:
    extra_kwargs = {}

...
from .common import ember_pipe, EmberPipeSpec
...
class NoopPipe(Pipe):
    ...
    def _to_inprocess(
        ...
        variant = InProcessNoopPipeVariant(self.input_pipes[0].pipe_variant)
        return variant
    ...
    def _to_multiprocess(
        ...
        variant = MultiprocessNoopPipeVariant(
            self.input_pipes[0].pipe_variant, variant_ctx.service
        )
        return variant
    ...
    def _to_multithreaded(
        ...
        return MultithreadedNoopPipeVariant(
            self.input_pipes[0].pipe_variant, variant_ctx
        )

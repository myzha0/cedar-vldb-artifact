...
class EmberPipeSpec:
    """
    A specification used to describe the properties of ember Pipes
...
def ember_pipe(spec: EmberPipeSpec) -> Any:
    """
    Decorator for ember Pipes. Used to provide an `EmberPipeSpec` to describe
